    ...
    <section id="philosophy" className="py-24 md:py-32 px-6 border-t border-neutral-900 bg-neutral-950 relative overflow-hidden">
      ...
      <div className="max-w-5xl mx-auto space-y-20 relative z-10">
        ...
        <div className="grid md:grid-cols-12 gap-8 items-center pt-4">
          ...
          >
            <Image
              src="https://lh3.googleusercontent.com/aida-public/AB6AXuA6YDtfbATVabGKSNXrIpgXGNhyrXpoyzAP2tK35uMHr_lep-BpSAw6sTpAmBmJrXRXiqilZYCvCFF9VgPdaQblIR5NXGkg-XAfkD_ncL7W6BkkHRrsohOqc-h8-a1tz5FufpFlviShgFi-AqqmcSJsrOvZ040bjsvi1lVUDMquAJ0ydkCh9vb-Ydd4_z6aIv8e4gQ6vDHk6XZLwKdMTy1WiZ2jPy9HTGIdB8KFHLQoBsy6wiJpmrs8a2OZgtRy5u0Mhf0d_7PnCZ4"
              alt="고요함 속의 과녁과 사수"
              fill
              className="object-cover opacity-70 group-hover:scale-[1.02] transition-transform duration-1000 grayscale"
          ...
          >
            <Image
              src="https://lh3.googleusercontent.com/aida-public/AB6AXuBBYxp1oFMN1Dh-es0Uujg8icwvKTvBygK3Tz4Q6pNpFnOC4wq1_6dWP_mbxV3fUu4cok-HIKNCKy0WYs98qAopohGo3Jvht9zmwaZfECwwaGGRw9xWZ003QfmsAHatzz975TkJfGS20xlSuOeqUInidW9Bz29FsW3-2XHoC0dgKixTznhQTtgMabzfFgDF635DWrE1zybAlbYqZXA6crUsI5kH7FS175u1Ixz5Mh1DgFtWlLltPhgadyodNyQ6-3ZCbJ2eCBnjGBY"
              alt="장인의 조각공정"
              fill
              className="object-cover opacity-70 group-hover:scale-[1.02] transition-transform duration-1000 grayscale"
          ...
          >
            <div className="space-y-4">
              ...
              <p className="text-xs text-neutral-400 leading-relaxed font-light">
                궁사 개개인의 손가락 관절과 힘의 균형을 정밀 분석하여 관절의 통증과 시위 미끄러짐을 완벽히 해결합니다.
              </p>
            </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="md:col-span-2 space-y-4">
              <h4 className="font-serif-kr text-xl text-neutral-100">
                각지장(깍지장) 양봉석의 명품 수제 깍지공예
              </h4>
              <p className="text-xs text-neutral-400 leading-relaxed font-light">
                30년 이상의 오랜 경력 속에서, 각지장 양봉석 장인이 궁사 한 분만을 위해 나무결을 손수 가다듬습니다. 깍지는 단순한 활쏘기 장비가 아닙니다. 화살의 궤적을 좌우하고 시수(화살의 착탄 분포)를 결정하는 궁사의 심장과도 같습니다.
              </p>
              <p className="text-xs text-neutral-400 leading-relaxed font-light">
            ...
            <div className="border-t md:border-t-0 md:border-l border-neutral-900 pt-6 md:pt-0 md:pl-8 flex flex-col justify-center space-y-4">
              <div>
                ...
                <span className="text-xs text-neutral-400 font-light font-serif-kr ml-1">일간의 제작 기간</span>
              </div>
              <div>
                <span className="text-2xl font-serif-en text-gold-500">30</span>
                <span className="text-xs text-neutral-400 font-light font-serif-kr ml-1">년 이상의 연마 경력</span>
              </div>
              <div>
                <span className="text-2xl font-serif-en text-gold-500">1:1</span>
                <span className="text-xs text-neutral-400 font-light font-serif-kr ml-1">정밀 맞춤 커스터마이징</span>
              </div>
            </div>
          </div>
        </motion.div>
