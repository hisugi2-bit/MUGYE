    ...
    <section id="science" className="py-24 md:py-32 px-6 border-t border-neutral-900 bg-neutral-950 relative overflow-hidden">
      ...
      <div className="max-w-5xl mx-auto space-y-16 relative z-10">
        ...
        <div className="text-center space-y-4">
          <h2 className="text-[10px] uppercase tracking-[0.4em] text-gold-500 font-medium">Archery Physics & Anatomy</h2>
          ...
          >
            <div className="space-y-4">
              ...
              <blockquote className="border-l-2 border-gold-500 pl-4 py-1 my-3">
                <p className="text-xs text-neutral-300 italic font-serif-kr leading-relaxed">
        ...
        >
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="space-y-2">
              ...
              <h5 className="font-serif-kr text-sm text-neutral-200">초밀착 내경 맞춤</h5>
            ...
            <div className="space-y-2">
              ...
              <h5 className="font-serif-kr text-sm text-neutral-200">고경도 목재 내마모성</h5>
              <p className="text-[11px] text-neutral-400 leading-relaxed font-light">
            ...
            <div className="space-y-2">
              ...
              <h5 className="font-serif-kr text-sm text-neutral-200">6개 부위 정밀 튜닝</h5>
              <p className="text-[11px] text-neutral-400 leading-relaxed font-light">
